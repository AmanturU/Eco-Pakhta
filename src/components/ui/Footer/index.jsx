    ...
    <footer className="bg-[#fec223] text-white px-4 md:px-24 lg:px-46 min-[1430px]:px-96 mt-14 pt-4">
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between px-4">
        ...
        <div className="flex items-center justify-center mb-4 md:mb-0">
          <img src="/public/logo-enactus.png" alt="enactus-logo" width={'80px'} />
          <div className="flex flex-col justify-center ml-2">
            <span className="text-xl font-medium font-Poppins">EcoPakhta</span>
            <p className="text-center mb-4">🌍 Ecological insulations for your home</p>
          </div>
        </div>
        ...
        <div className="flex items-center">
          ...
          <a href="#" className="mr-5">
            <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="40" height="40" id="email" x="0" y="0" version="1.1" viewBox="0 0 100 100">
              <path fill="#A35BB4" d="M88 2H12C6.477 2 2 6.477 2 12v76c0 5.523 4.477 10 10 10h76c5.523 0 10-4.477 10-10V12c0-5.523-4.477-10-10-10z"></path>
              <g fill="#FFF"></g>
              <g fill="#FFF">
          ...
          <a href="#">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" aria-label="Telegram" viewBox="0 0 512 512" id="telegram">
